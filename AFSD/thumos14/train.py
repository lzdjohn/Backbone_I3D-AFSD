...
if __name__ == '__main__':
    ...
    for i in range(1, max_epoch + 1):
        print(i)
        checkpoint_path = "/home/lzdjohn/AFSD/AFSDtime2/AFSD/thumos14/models/thumos14/checkpoint-" + str(i) + ".ckpt"
        json_name = "/home/lzdjohn/AFSD/AFSDtime2/AFSD/thumos14/output/" + str(i) + ".json"
        ...
        if fusion:
            ...
            net = BDNet(in_channels=config['model']['in_channels'],
                        backbone_model=config['model']['backbone_model'],
                        training=True)
            net = nn.DataParallel(net, device_ids=[0, 1, 2, 3, 4, 5, 6, 7]).cuda()
            # net = net.cuda()
        ...
        for video_name in tqdm.tqdm(list(video_infos.keys()), ncols=0):
            ...
            # data = data.permute(2, 0, 3, 1).contiguous()
    ...
    # parser.add_argument('output_json', type=str, default='/home/lzdjohn/AFSD/AFSD/AFSD/thumos14/output/detection_results.json', nargs='?')
    # parser.add_argument('gt_json', type=str, default='/home/lzdjohn/AFSD/AFSD/thumos_annotations/thumos_gt.json', nargs='?')
    ...
    y = []
    for i in range(1, max_epoch + 1):
        gt_json = '/home/lzdjohn/AFSD/AFSDtime2/thumos_annotations/thumos_gt.json'
        output_json = '/home/lzdjohn/AFSD/AFSDtime2/AFSD/thumos14/output/' + str(i) + ".json"
